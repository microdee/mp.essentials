...
namespace VVVV.Nodes
{
    ...
    public class CompoundFdpGraphlayoutNodeOld : IPluginEvaluate, IPartImportsSatisfiedNotification
    {
        [Import]
        ...
        private CompoundGraph<string, IEdge<string>> graph = new CompoundGraph<string, IEdge<string>>(true);
        private CompoundFDPLayoutAlgorithm<string, IEdge<string>, CompoundGraph<string, IEdge<string>>> layout;
